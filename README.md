...
Now that your ember-cli project relies on ruby code, it's probably a good idea
to document your gem dependencies in a Gemfile manifest. Using bundler will also 
